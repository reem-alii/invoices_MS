...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Welcome to the invoice system, (
                    </h2>
            </div>
        </div>
            ...
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">EGP
            ...
            <div class="card">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    <div class="d-flex justify-content-between">
                        <h1 class="card-title mb-0"> نسبة احصائيلت الفواتير</h1>
        ...
        <div class="col-lg-12 col-xl-5">
            <div class="card card-dashboard-map-one">
                ...
                <div class="">
                    ...
                    {{-- <div class="vmap-wrapper ht-180" id="vmap2"  style="height:236px;"></div> --}}
                </div>
            </div>
        </div>
    </div>
